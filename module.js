M.block_accessibility = {
    ...
    */
    ...
    load_atbar: function() {
        ...
        var myElement1 = document.querySelector(".navbar-fixed-top");
        myElement1.style.top = "40px";
        var myElement2 = document.querySelector(".dockeditem_container");
        myElement2.style.top = "104px";
    },
